namespace Palitra27.Web.ViewModels.Orders
{
    ...
    using Palitra27.Web.ViewModels.ValidationAttributes;
    ...
    public class OrderCreateBindingModel
    {
        ...
        [Required]
        [RegularExpression(@"[0-9]{7,12}", ErrorMessage = "The phone number is not a valid phone number.")]
        ...
        [Required]
        [RegularExpression(@"^[A-Za-z0-9.,-]+$", ErrorMessage = "The ZIP is invalid.")]
